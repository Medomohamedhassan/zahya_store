...
class DetailedProduct {
  ...
  factory DetailedProduct.fromJson(Map<String, dynamic> json) {
    ...
    return DetailedProduct(
      ...
      earn_point: json["earn_point"] == null ? 0 : json["earn_point"].toInt(),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "video_link": video_link == null
            ? []
            : List<dynamic>.from(video_link!.map((x) => x)),
        "videos": videos == null
            ? []
...
class Brand {
  ...
  factory Brand.fromJson(Map<String, dynamic> json) => Brand(
      ...
      logo: json["logo"]);
  Map<String, dynamic> toJson() =>
      {"id": id, "slug": slug, "name": name, "logo": logo};
}
...
class Wholesale {
  ...
  factory Wholesale.fromJson(Map<String, dynamic> json) => Wholesale(
      minQty: json["min_qty"], maxQty: json["max_qty"], price: json["price"]);
  Map<String, dynamic> toJson() =>
      {"min_qty": minQty, "max_qty": maxQty, "price": price};
}
