...
class MyTheme {
  ...
  static Color mainColor = Color(0xff7A9A2D);
  static const Color accent_color = Color(0xff7A9A2D);
  static const Color accent_color_shadow =
      Color.fromRGBO(122, 154, 45, .40); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(122, 154, 45, 0.15);
  static Color splash_screen_color = Color(0xff7A9A2D);
  static Color price_color = Color(0xff7A9A2D);
  static Color secondary_brand_color = Color(0xffB9C348);
  ...
  static Color golden = Color(0xffB9C348);
  ...
  static TextTheme textTheme1 = TextTheme(
    bodyLarge: TextStyle(fontFamily: "PublicSansSerif", fontSize: 16),
    bodyMedium: TextStyle(fontFamily: "PublicSansSerif", fontSize: 14),
  );
