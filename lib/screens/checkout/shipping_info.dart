...
class _ShippingInfoState extends State<ShippingInfo> {
  ...
  getDeliveryInfo() async {
    ...
    for (var element in _deliveryInfoList) {
      ...
      _sellerWiseShippingOption.add(SellerWithShipping(
        element.ownerId,
        shippingOption,
        shippingId,
            ...
            children: [
              ...
              SizedBox(
                ...
                child: FadeInImage.assetNetwork(
                  ...
                  image: validateImageUrl(_deliveryInfoList[sellerArrayIndex]
                      .carriers!
                      .data![carrierIndex]
                      .logo!),
                  fit: BoxFit.fitWidth,
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.start, children: <Widget>[
        SizedBox(
          ...
          child: ClipRRect(
            ...
            child: FadeInImage.assetNetwork(
              placeholder: 'assets/placeholder.png',
              image: validateImageUrl(_deliveryInfoList[sellerIndex]
                  .cartItems![itemIndex]
