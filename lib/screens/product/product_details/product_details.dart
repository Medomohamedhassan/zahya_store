  ...
  setProductDetailValues() {
    if (_productDetails != null) {
      ...
      if (_productDetails!.videos != null) {
        for (var video in _productDetails!.videos!) {
          ...
          if (thumbnail == null || thumbnail.isEmpty) {
            thumbnail = _productDetails!.thumbnail_image;
          }
      ...
      if (_productDetails!.video_link != null) {
        for (var ytLink in _productDetails!.video_link!) {
                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          image: validateImageUrl(_productDetails!.shop_logo!),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
        ...
        BottomNavigationBarItem(
          ...
          icon: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(6.0),
                color: MyTheme.secondary_brand_color,
                boxShadow: [
                  BoxShadow(
                    color: MyTheme.black_shadow,
                    blurRadius: 20,
                      ...
                      child: Container(
                        ...
                        child: ClipRRect(
                          ...
                          child:
                            ...
                            placeholder: 'assets/placeholder.png',
                            image: validateImageUrl(_productImageList[index]),
                            fit: BoxFit.contain,
                          ),
                        ),
                      ),
            ...
            child: SizedBox(
              ...
              child: Container(
                child: FadeInImage.assetNetwork(
                  ...
                  image: validateImageUrl(_productImageList[_currentImage]),
              ...
              child: Stack(
                children: [
                  PhotoView(
                    ...
                    imageProvider: NetworkImage(validateImageUrl(path)),
                  ),
                  Align(
                ...
                if (mediaItem.type == 'image') {
                  child = InkWell(
                    ...
                    child: SizedBox(
                      ...
                      child: FadeInImage.assetNetwork(
                        placeholder: 'assets/placeholder.png',
                        image: validateImageUrl(mediaItem.url),
                        fit: BoxFit.contain,
                      ),
                    ),
                  );
      ...
      child: Stack(
        ...
        children: [
          if (mediaItem.thumbnail != null && mediaItem.thumbnail!.isNotEmpty)
            FadeInImage.assetNetwork(
              placeholder: 'assets/placeholder.png',
              image: validateImageUrl(mediaItem.thumbnail!),
              fit: BoxFit.cover,
            )
            ...
            child: Stack(
              children: [
                PhotoView(
                  ...
                  imageProvider:
                      CachedNetworkImageProvider(validateImageUrl(path)),
                ),
                Align(
                  alignment: Alignment.topRight,
                  child: Container(
