...
class _ProductReviewsState extends State<ProductReviews> {
  ...
  void onTapReviewSubmit(BuildContext context) async {
    ...
    String image_ids = _selectedReviewImages.map((image) => image.id).join(',');
                    ...
                    showDialog(
                      ...
                      builder: (_) => Dialog(
                        child: FadeInImage.assetNetwork(
                          ...
                          image: validateImageUrl(imagePath),
                        ),
                      ),
                    );
                  }
          ...
          children: <Widget>[
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: const Color.fromRGBO(112, 112, 112, .3)),
              ),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(35),
                child: (_reviewList[index].avatar != null &&
                    ...
                    ? FadeInImage.assetNetwork(
                        placeholder: 'assets/placeholder.png',
                        image: validateImageUrl(_reviewList[index].avatar),
                        fit: BoxFit.cover,
                      )
                    : Image.asset(
                        'assets/placeholder.png',
              ...
              child: Container(
                ...
                child: const Center(
                  child: Icon(Icons.add_a_photo_outlined,
                      color: MyTheme.font_grey, size: 20),
                ),
              ),
            ),
