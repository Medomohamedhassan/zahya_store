...
class _ProfileState extends State<Profile> {
  ...
  Future<bool> _showPermissionDialog(
      BuildContext context, String purpose) async {
                ...
                buildBottomVerticalCardListItem(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) {
                          return Filter(selected_filter: "sellers");
                        },
                      ),
                    );
                  },
  ...
  //             bool userAgreed = await _showPermissionDialog(context, purpose);
  //
  //             if (userAgreed) {
  //               Navigator.push(
  //                 context,
  ...
  //               );
  //             } else {
  //               ToastComponent.showDialog("Permission is required to upload files.");
  //             }
  //           }
  //               : () => null,
  //         ),
  ...
  //         const double crossAxisSpacing = 15.0;
  ...
  //                     "To upload files, the app needs access to your device's storage.";
  //                 bool userAgreed =
  //                 await _showPermissionDialog(context, purpose);
  //
  //                 if (userAgreed) {
  //                   Navigator.push(
  //                     context,
              ...
              child: is_logged_in.$
                  ? ClipRRect(
                      ...
                      child: FadeInImage.assetNetwork(
                        ...
                        image: validateImageUrl("${avatar_original.$}"),
                        fit: BoxFit.fill,
                      ),
                    )
                  : Image.asset(
