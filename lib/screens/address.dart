  ...
  fetchShippingAddressList() async {
    ...
    if (_shippingAddressList.isNotEmpty) {
      for (var address in _shippingAddressList) {
        ...
        _areaControllerListForUpdate
            .add(TextEditingController(text: address.area_name));
        ...
        _selected_area_list_for_update
            .add(City(id: address.area_id, name: address.area_name));
      }
    }
    setState(() {});
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_shippingAddressList[index].area_name != null &&
                    ...
                    buildAddressInfoRow(
                        "Area", _shippingAddressList[index].area_name ?? ""),
