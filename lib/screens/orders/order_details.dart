            ...
            startChild: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    width:
                        _orderDetails!.delivery_status == "carrier" ? 36 : 30,
                    height:
                        _orderDetails!.delivery_status == "carrier" ? 36 : 30,
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(5),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (_orderDetails!.tracking_code != null &&
                _orderDetails!.tracking_code!.isNotEmpty)
              Padding(
                padding: const EdgeInsets.only(bottom: 8.0),
                child: Row(
                  children: [
                    ...
                    InkWell(
                      onTap: () {
                        launchUrl(Uri.parse(
                            "https://bosta.co/tracking-shipment/?trackingNumber=${_orderDetails!.tracking_code}"));
                      },
                      child: Text(
                        _orderDetails!.tracking_code!,
                        style: TextStyle(
                            color: Colors.blue,
