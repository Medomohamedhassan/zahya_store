...
''');
        ...
        onMessageReceived: (JavaScriptMessage message) {
          ...
          if (mounted && message.message.isNotEmpty && message.message != "error") {
            setState(() {
              ...
              log("reCAPTCHA key has been SET successfully: ${googleRecaptchaKey.substring(0, 20)}...");
            });
          } else {
  ...
  onPressSignUp() async {
    if (recaptcha_customer_register.$ && (!_isWebViewReady || googleRecaptchaKey.isEmpty)) {
