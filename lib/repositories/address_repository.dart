...
class AddressRepository {
  ...
  Future<CityResponse> getCityListByCountry(
      {int country_id = 0, name = ""}) async {
    String url =
    ("${AppConfig.BASE_URL}/cities-by-country/$country_id?name=$name");
    final response = await ApiRequest.get(
      url: url,
      headers: {
        "Content-Type": "application/json",
  ...
  Future<dynamic> getAriaListByCity({city_id = 0, name = ""}) async {
    String url = ("${AppConfig.BASE_URL}/areas-by-city/$city_id?name=$name");
  ...
  Future<dynamic> getShippingCostResponse({shipping_type = ""}) async {
    ...
    final response = await ApiRequest.post(
        ...
        body: postBody,
        middleware: BannedUser());
    print('cost respond-------$shipping_type');
  ...
  Future<dynamic> getAddressUpdateInCartResponse(
    ...
    final response = await ApiRequest.post(
        ...
        body: postBody,
        middleware: BannedUser());
    print('shippingggggg....${response.body}');
  ...
  Future<dynamic> getShippingTypeUpdateInCartResponse(
    ...
    final response = await ApiRequest.post(
        ...
        body: postBody,
        middleware: BannedUser());
    print("getShippingTypeUpdateInCartResponse--------${response.body}");
